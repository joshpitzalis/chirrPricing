...
const hobbyFeatures = ['Smart automatic text splitting', 'Add upto 10 tweets per thread', 'Publish 1 image per thread', 'Preview Thread before publishing', 'A public page with all your top tweets' ]
const growthFeatures = [
  'All the free features', 'Smart automatic text splitting', 'Unlimited tweets per thread', 'Add as many images as you want','Preview Thread before you publish','Save drafts and work-in-progress', 'Store a complete history of all your tweets', 'A public page with all your top tweets'
  
]
const scaleFeatures = ['All the Plus Features',
'Scheduling',
'Slow release tweets in a thread',
'Blitz replies',
'Analytics',
      ...
      <div className="pt-12 px-4 sm:px-6 lg:px-8 lg:pt-20">
        <div className="text-center">
          ...
          <p className="mt-3 max-w-4xl mx-auto text-xl text-gray-300 sm:mt-5 sm:text-2xl">
            You can use the editor for free forever, you can pay for added functionality like unlimited drafts, scheduling and analytics.
          </p>
        </div>
      </div>
                    ...
                    <div>
                      ...
                      <div className="mt-4 flex items-center justify-center">
                        <span className="px-3 flex items-start text-6xl tracking-tight text-gray-900 sm:text-6xl">
                          <span className="mt-2 mr-2 text-4xl font-medium">$</span>
                          <span className="font-extrabold">2.5</span>
                        </span>
