          ...
          <div className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6">
            <div className="text-center">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block">Make Twitter Threads</span>
                <span className="block text-indigo-600">quickly and easily.</span>
              </h1>
              <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
                An online text editor that turns blog posts into Twitter threads.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="relative">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <img
              ...
              src={`${process.env.PUBLIC_URL}/images/demoScreen.png`}
              alt="App screenshot"
            />
          </div>
        </div>
      ...
      {/* <div className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-16 px-4 sm:py-24 sm:px-6 lg:px-8">
          <h2 className="text-center text-gray-400 text-sm font-semibold uppercase tracking-wide">
            ...
            TRUSTED BY 19,142 FANTASTIC PEOPLE 
          </h2>
